function G_st=hedricks(POP1,POP2,varargin)
% HEDRICKS - determines Hedricks's G'st (2005)
%   Returns Hedricks's G'st value described in his article from 2005
%
...
%%HT_max and Gst_max
HT_max=(NumPop-1+HS_est)./NumPop;
Gst_max=(HT_max-HS_est)./HT_max;
